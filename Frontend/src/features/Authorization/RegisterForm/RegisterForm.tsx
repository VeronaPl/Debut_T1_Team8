            ...
            <Form
                ...
                render={({ handleSubmit, submitting, pristine }) => (
                    <form className='login-form' onSubmit={handleSubmit} autoComplete='off'>
                      ...
                      <LoginButton className="register" title='Зарегистрироваться' type='submit' color='green' disabled={submitting || pristine} />
                      <div className='or'>или</div>
                      <div className='other' onClick={() => router('/login')}>Войти</div>
                    </form>
                )}
            />
        </div>
